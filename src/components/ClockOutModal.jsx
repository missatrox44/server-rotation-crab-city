            ...
            <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
              <div className="sm:flex sm:items-start">
                ...
                <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                  <h3 className="text-base font-bold leading-10 text-2xl text-gray-900" id="modal-title">{employee.employeeName}</h3>
                  <div className="mt-2">
                    <p className="text-sm text-gray-500 text-lg">Are you sure you want to clock out?</p>
                  </div>
                </div>
              </div>
            </div>
